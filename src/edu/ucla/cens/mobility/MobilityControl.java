		...
		public boolean onPreferenceChange(Preference pref, Object val)
		{
			...
			if (pref_key.compareTo(KEY_MOBILITY_ONOFF_PREF) == 0)
			{
				...
				if (value.booleanValue())
				{
					...
					editor.commit();
//					startService(new Intent(MobilityControl.this, MobilityService.class));
				...
				else
				{
					...
					editor.commit();
//					stopService(new Intent(MobilityControl.this, MobilityService.class));
