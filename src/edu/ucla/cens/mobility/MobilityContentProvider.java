...
public class MobilityContentProvider extends ContentProvider
{
	...
	public Cursor query(Uri uri, String[] columns, String selection, String[] selectionArgs, String sortOrder) 
	{
		...
		if(mUriMatcher.match(uri) == URI_CODE_MOBILITY)
		{
			...
			mda = new MobilityDbAdapter(getContext(), "mobility", "mobility", "mobility");
	...
	MobilityDbAdapter mda; // This being a member instead of local to query avoids leaking I hope
	/**
